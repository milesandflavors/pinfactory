...
TMPL = {
    ("3-days-in-rome-itinerary", "5"):        "Title bottom",
    ("best-canal-cruises-in-amsterdam", "2"): "Title top dark",
    ("things-to-do-in-sao-miguel", "3"):      "Centered dark",
}
FOTO = {
    ("4-days-in-barcelona", "5"): "3",  # Park Guell (index 2)
}
